package com.camunda.camundapoc.camunda.process.configuration.logger.plugin;
...
/**
 * Decide on which elements to add the listener. Allows to inspect basically everything that happens
 * within Camunda.
 */
public class AddSendEventListenerToBpmnParseListener implements BpmnParseListener {

  // Adding listeners for Logging
  @Override
  ...
  public void parseStartEvent(
      Element startEventElement, ScopeImpl scope, ActivityImpl startEventActivity) {}
  ...
  public void parseBoundaryTimerEventDefinition(
      Element timerEventDefinition, boolean interrupting, ActivityImpl timerActivity) {}
  ...
  public void parseReceiveTask(
      Element receiveTaskElement, ScopeImpl scope, ActivityImpl activity) {}
  ...
  public void parseBoundarySignalEventDefinition(
      Element signalEventDefinition, boolean interrupting, ActivityImpl signalActivity) {}
  ...
  public void parseTransaction(
      Element transactionElement, ScopeImpl scope, ActivityImpl activity) {}
  ...
  public void parseBoundaryEvent(
      Element boundaryEventElement, ScopeImpl scopeElement, ActivityImpl nestedActivity) {}

  @Override
  public void parseBoundaryMessageEventDefinition(
      Element element, boolean interrupting, ActivityImpl messageActivity) {}
